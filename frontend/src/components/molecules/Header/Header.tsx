    ...
    return (
            <Box>
                <AppBar position="static">
                    ...
                    {checkRole("ADMIN") && <Button data-cy={"header-users"} variant="outlined" sx={buttonStyle} onClick={() => navigate('/users')}>Users</Button>}
                    {checkRole("USER") && <Button variant="outlined" sx={buttonStyle} onClick={() => navigate(`/users/${user?.id}`)}>Account</Button>}
                    {checkRole("ADMIN") && <Button data-cy={"header-create-user"}variant="outlined" sx={buttonStyle} onClick={() => navigate('/register')}>Create New User</Button>}
